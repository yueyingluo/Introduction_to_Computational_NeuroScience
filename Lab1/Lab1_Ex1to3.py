...
# Plot conductance
plt.subplot(2, 2, 4)
plt.plot(t, [soma(0.5).hh1.gnabar * m[i]**3 * h_gate[i] for i in range(len(t))], label='gNa (S/cm2)', color='red')
plt.plot(t, [soma(0.5).hh1.gkbar * n[i]**4 for i in range(len(t))], label='gK (S/cm2)', color='blue')
