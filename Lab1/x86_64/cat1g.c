...
#define cao cao_cat1g
 double cao = 2;
#define cai cai_cat1g
 double cai = 5e-05;
#define kl kl_cat1g
 double kl = -5.4;
#define kn kn_cat1g
 double kn = 6.53;
#define linf linf_cat1g
 double linf = 0;
#define ninf ninf_cat1g
 double ninf = 0;
#define q10 q10_cat1g
 double q10 = 2.3;
#define taun taun_cat1g
 double taun = 0;
#define taul taul_cat1g
 double taul = 0;
#define vhalfl vhalfl_cat1g
 double vhalfl = -85.4;
#define vhalfn vhalfn_cat1g
 double vhalfn = -51.73;
 ...
 "vhalfn_cat1g", &vhalfn_cat1g,
 "vhalfl_cat1g", &vhalfl_cat1g,
 "kn_cat1g", &kn_cat1g,
 "kl_cat1g", &kl_cat1g,
 "q10_cat1g", &q10_cat1g,
 "cai_cat1g", &cai_cat1g,
 "cao_cat1g", &cao_cat1g,
 "ninf_cat1g", &ninf_cat1g,
 "linf_cat1g", &linf_cat1g,
 "taul_cat1g", &taul_cat1g,
 "taun_cat1g", &taun_cat1g,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 cat1g /Users/moyoumo/Desktop/lab/mod/cat1g.mod\n");
 ...
 v=_v;
{
  eca = _ion_eca;
 { error =  states();
 if(error){fprintf(stderr,"at line 58 in file cat1g.mod:\n	SOLVE states METHOD cnexp\n"); nrn_complain(_p); abort_run(error);}
 } }}
...
#if NMODL_TEXT
static const char* nmodl_filename = "/Users/moyoumo/Desktop/lab/mod/cat1g.mod";
static const char* nmodl_file_text = 
