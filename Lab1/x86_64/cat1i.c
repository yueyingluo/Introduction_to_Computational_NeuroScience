...
#define nrn_init _nrn_init__cat1i
#define _nrn_initial _nrn_initial__cat1i
#define nrn_cur _nrn_cur__cat1i
#define _nrn_current _nrn_current__cat1i
#define nrn_jacob _nrn_jacob__cat1i
#define nrn_state _nrn_state__cat1i
#define _net_receive _net_receive__cat1i 
#define rates rates__cat1i 
#define states states__cat1i 
...
extern void hoc_reg_nmodl_filename(int, const char*);
 ...
 "setdata_cat1i", _hoc_setdata,
 "rates_cat1i", _hoc_rates,
 0, 0
};
 /* declare global and static user variables */
#define cao cao_cat1i
 double cao = 2;
#define cai cai_cat1i
 double cai = 5e-05;
#define kl kl_cat1i
 double kl = -5.4;
#define kn kn_cat1i
 double kn = 8.39;
#define linf linf_cat1i
 double linf = 0;
#define ninf ninf_cat1i
 double ninf = 0;
#define q10 q10_cat1i
 double q10 = 2.3;
#define taun taun_cat1i
 double taun = 0;
#define taul taul_cat1i
 double taul = 0;
#define vhalfl vhalfl_cat1i
 double vhalfl = -93.2;
#define vhalfn vhalfn_cat1i
 double vhalfn = -60.7;
 ...
 "vhalfn_cat1i", &vhalfn_cat1i,
 "vhalfl_cat1i", &vhalfl_cat1i,
 "kn_cat1i", &kn_cat1i,
 "kl_cat1i", &kl_cat1i,
 "q10_cat1i", &q10_cat1i,
 "cai_cat1i", &cai_cat1i,
 "cao_cat1i", &cao_cat1i,
 "ninf_cat1i", &ninf_cat1i,
 "linf_cat1i", &linf_cat1i,
 "taul_cat1i", &taul_cat1i,
 "taun_cat1i", &taun_cat1i,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 cat1i /Users/moyoumo/Desktop/lab/mod/cat1i.mod\n");
 ...
 v=_v;
{
  eca = _ion_eca;
 { error =  states();
 if(error){fprintf(stderr,"at line 58 in file cat1i.mod:\n	SOLVE states METHOD cnexp\n"); nrn_complain(_p); abort_run(error);}
 } }}
...
#if NMODL_TEXT
static const char* nmodl_filename = "/Users/moyoumo/Desktop/lab/mod/cat1i.mod";
static const char* nmodl_file_text = 
